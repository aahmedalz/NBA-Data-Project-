...
I have contributed by preparing the analytical framework for the project. I have refined our research questions, outlined the Exploratory Data Analysis approach, and began planning for feature engineering and model strategy. In addition, I have ensured that we have sourced our datasets form the repository and that our project remains aligned with our goal to compare traditional and advanced metrics. This work will impact the next steps in analysis and model development. 
